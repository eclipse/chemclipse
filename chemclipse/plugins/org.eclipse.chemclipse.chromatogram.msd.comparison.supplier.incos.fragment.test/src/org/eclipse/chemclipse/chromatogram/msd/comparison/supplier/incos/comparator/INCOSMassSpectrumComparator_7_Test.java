...
public class INCOSMassSpectrumComparator_7_Test extends MassSpectrumSetTestCase {
	...
	public void test2() {
		...
		assertEquals(90.83925f, result.getMatchFactor());
	}

	public void test3() {

		assertEquals(83.93919f, result.getReverseMatchFactor());
	}
}
