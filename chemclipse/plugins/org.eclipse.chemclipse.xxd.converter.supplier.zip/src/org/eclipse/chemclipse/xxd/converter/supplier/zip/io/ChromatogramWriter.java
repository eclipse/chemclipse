...
public class ChromatogramWriter extends AbstractChromatogramMSDWriter {
	...
	public void writeChromatogram(File file, IChromatogramMSD chromatogram, IProgressMonitor monitor) throws FileIsNotWriteableException, IOException {
		...
		IProcessingInfo<File> processingInfo = ChromatogramConverterMSD.getInstance().convert(destinationFile, chromatogram, IFormatVersion.CONVERTER_ID_CHROMATOGRAM, monitor);
