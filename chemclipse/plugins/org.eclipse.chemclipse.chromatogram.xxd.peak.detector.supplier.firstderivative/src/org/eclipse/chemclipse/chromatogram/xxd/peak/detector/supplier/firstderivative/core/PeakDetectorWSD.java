...
public class PeakDetectorWSD extends AbstractPeakDetectorWSD {
	...
	private void setThresholdValue(IPeakDetectorSettings peakDetectorSettings) {
		...
		if(peakDetectorSettings instanceof IFirstDerivativePeakDetectorWSDSettings) {
			IFirstDerivativePeakDetectorWSDSettings firstDerivativePeakDetectorSettings = (IFirstDerivativePeakDetectorWSDSettings)peakDetectorSettings;
			/*
	 ...
	 */
	private void detectPeaks(IChromatogramSelectionWSD chromatogramSelection, IProgressMonitor monitor) {
		...
		buildAndStorePeaks(rawPeaks, chromatogramSelection.getChromatogramWSD());
	}
	 ...
	 * @param chromatogram
	 */
	private void buildAndStorePeaks(List<IRawPeak> rawPeaks, IChromatogramWSD chromatogram) {
	 ...
	 */
	private IFirstDerivativeDetectorSlopes getFirstDerivativeSlopes(IChromatogramSelectionWSD chromatogramSelection) {
