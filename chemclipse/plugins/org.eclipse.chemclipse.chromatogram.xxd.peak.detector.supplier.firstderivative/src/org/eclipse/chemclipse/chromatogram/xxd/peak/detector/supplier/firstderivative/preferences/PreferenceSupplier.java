...
public class PreferenceSupplier extends AbstractPreferenceSupplier implements IPreferenceSupplier {
	...
	public Map<String, String> getDefaultValues() {
		...
		defaultValues.put(P_FILTER_MODE_MSD, DEF_FILTER_MODE_MSD);
		defaultValues.put(P_MZ_VALUES_TO_FILTER_MSD, DEF_MZ_VALUES_TO_FILTER_MSD);
		defaultValues.put(P_USE_INDIVIDUAL_TRACES_MSD, Boolean.toString(DEF_USE_INDIVIDUAL_TRACES_MSD));
		//
