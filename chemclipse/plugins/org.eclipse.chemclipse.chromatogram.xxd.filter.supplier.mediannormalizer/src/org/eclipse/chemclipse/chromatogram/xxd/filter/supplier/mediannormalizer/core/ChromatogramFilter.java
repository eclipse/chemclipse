...
import org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.mediannormalizer.exceptions.FilterException;
...
public class ChromatogramFilter extends AbstractChromatogramFilter {
	...
	public IProcessingInfo applyFilter(IChromatogramSelection chromatogramSelection, IChromatogramFilterSettings chromatogramFilterSettings, IProgressMonitor monitor) {
		...
		if(!processingInfo.hasErrorMessages()) {
			if(chromatogramFilterSettings instanceof FilterSettings) {
				try {
					applyMedianNormalizerFilter(chromatogramSelection);
	...
	@SuppressWarnings("unchecked")
	private void applyMedianNormalizerFilter(IChromatogramSelection chromatogramSelection) throws FilterException {
		...
		try {
			...
			TotalScanSignalsModifier.medianNormalize(totalScanSignals);
