...
public class ScanWriter {
	...
	private Spectrum createSpectrum(ISpectrumVSD ir) {
	...
	private SpectrumData createSpectrumData(ISpectrumVSD ir) {
	...
	private Xaxis createXAxis(ISpectrumVSD ir) {

		Xaxis xAxis = new Xaxis();
		StringBuilder wavenumbers = new StringBuilder();
		for(ISignalVSD signal : ir.getScanVSD().getProcessedSignals()) {
	...
	private Yaxis createYAxis(ISpectrumVSD ir) {
