...
public class GeometricDistanceCalculator_7_Test extends MassSpectrumSetTestCase {
	...
	public void test1() {
		...
		assertEquals(0.9513092f, calculator.calculate(unknown, reference, unknown.getExtractedIonSignal().getIonRange()));
	}
	...
	public void test2() {
		...
		assertEquals(0.94751626f, calculator.calculate(unknown, reference, unknown.getExtractedIonSignal().getIonRange()));
	}
