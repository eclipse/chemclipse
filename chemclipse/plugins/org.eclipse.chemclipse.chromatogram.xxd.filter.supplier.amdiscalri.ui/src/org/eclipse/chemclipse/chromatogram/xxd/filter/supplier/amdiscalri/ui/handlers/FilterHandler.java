 ...
 *******************************************************************************/
package org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.amdiscalri.ui.handlers;
...
import org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.amdiscalri.ui.modifier.FilterRunnable;
...
public class FilterHandler implements EventHandler {
	...
	public void execute() {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start RI Calculator Filter");
			/*
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "RI Calculator finished");
		}
	}
