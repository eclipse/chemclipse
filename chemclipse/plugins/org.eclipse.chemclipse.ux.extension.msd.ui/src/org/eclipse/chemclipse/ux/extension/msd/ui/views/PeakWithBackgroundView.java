...
public class PeakWithBackgroundView extends AbstractChromatogramSelectionMSDView {
	...
	private void createControl() {
		...
		peakWithBackgroundUI = new PeakWithBackgroundUI(parent, SWT.NONE, new AxisTitlesMassScale());
	}
	...
	public void update(IChromatogramSelectionMSD chromatogramSelection, boolean forceReload) {
		...
		if(doUpdate(chromatogramSelection)) {
			update(chromatogramSelection.getSelectedPeak(), forceReload);
		}
	}
	...
	private void update(IPeakMSD peak, boolean forceReload) {
		...
		if(isPartVisible() && peak != null) {
			peakWithBackgroundUI.update(peak, forceReload);
		}
	}
}
