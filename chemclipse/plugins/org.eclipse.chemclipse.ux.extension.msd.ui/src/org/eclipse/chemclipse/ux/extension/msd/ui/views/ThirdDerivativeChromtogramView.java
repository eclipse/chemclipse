...
public class ThirdDerivativeChromtogramView extends AbstractChromatogramSelectionMSDView {
	...
	private void createControl() {
		...
		derivativeChromatogramUI = new DerivativeChromatogramUI(parent, 3, 1, SWT.NONE);
	}
