...
public class FirstDerivativeChromtogramView extends AbstractChromatogramSelectionMSDView {
	...
	@Inject
	public FirstDerivativeChromtogramView(EPartService partService, MPart part, IEventBroker eventBroker) {
	...
	private void createControl() {
		...
		derivativeChromatogramUI = new DerivativeChromatogramUI(parent, 1, 1, SWT.NONE);
	}
