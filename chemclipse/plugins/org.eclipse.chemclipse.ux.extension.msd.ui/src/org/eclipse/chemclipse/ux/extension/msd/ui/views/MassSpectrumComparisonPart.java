...
public class MassSpectrumComparisonPart extends AbstractMassSpectrumComparisonPart {
	...
	@Inject
	public MassSpectrumComparisonPart(EPartService partService, MPart part, IEventBroker eventBroker, EventHandler eventHandler) {
	...
	private void createControl() {
		...
		massSpectrumComparisonUI = new MassSpectrumComparisonUI(parent, SWT.BORDER, MassValueDisplayPrecision.NOMINAL, "REFERENCE", "COMPARISON");
		subscribe();
	}
