...
public class MassSpectrumIonsListView extends AbstractChromatogramSelectionMSDView {
	...
	private static final String POPUP_MENU_ID = "org.eclipse.chemclipse.chromatogram.msd.ui.perspective.views.massSpectrumIonsListView.popup";
	@Inject
	...
	public void update(IChromatogramSelectionMSD chromatogramSelection, boolean forceReload) {
		...
		if(doUpdate(chromatogramSelection)) {
			massSpectrumIonsListUI.update(chromatogramSelection.getSelectedScan(), forceReload);
		}
	}
