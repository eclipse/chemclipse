...
public class SimpleNominalMassSpectrumView extends AbstractMassSpectrumSelectionView {
	...
	@Inject
	public SimpleNominalMassSpectrumView(EPartService partService, MPart part, IEventBroker eventBroker) {
