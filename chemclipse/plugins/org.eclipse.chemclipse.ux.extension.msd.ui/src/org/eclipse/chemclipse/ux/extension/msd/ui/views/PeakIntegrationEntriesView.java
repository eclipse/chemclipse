...
import org.eclipse.chemclipse.msd.swt.ui.components.peak.PeakIntegrationEntriesUI;

public class PeakIntegrationEntriesView extends AbstractChromatogramSelectionMSDView {

	@Inject
	private Composite parent;
	private PeakIntegrationEntriesUI peakIntegrationEntriesUI;
	...
	private void createControl() {
		...
		peakIntegrationEntriesUI = new PeakIntegrationEntriesUI(parent, SWT.NONE);
	}
	...
	public void setFocus() {
		...
		peakIntegrationEntriesUI.setFocus();
	...
	public void update(IChromatogramSelectionMSD chromatogramSelection, boolean forceReload) {
		...
		if(doUpdate(chromatogramSelection)) {
			...
			if(peak != null) {
				peakIntegrationEntriesUI.update(peak, true);
			}
		}
	}
