...
public class ChromatogramFileSupport {
	 ...
	 * @param chromatogram
	 */
	private static void validateFile(FileDialog dialog, List<ISupplier> supplier, Shell shell, ChromatogramConverterSupport converterSupport, IChromatogramCSD chromatogram) {
