...
public class ChromatogramFileSupport {
	...
	public static boolean saveChromatogram(IChromatogramCSD chromatogram) throws NoConverterAvailableException {
		...
		IChromatogramConverterSupport converterSupport = ChromatogramConverterCSD.getInstance().getChromatogramConverterSupport();
		/*
	 ...
	 * @param supplier
	 */
	public static void writeFile(final File file, final IChromatogramCSD chromatogram, final ISupplier supplier) {
	 ...
	 * @param chromatogram
	 */
	private static void validateFile(FileDialog dialog, List<ISupplier> supplier, Shell shell, IChromatogramConverterSupport converterSupport, IChromatogramCSD chromatogram) {
