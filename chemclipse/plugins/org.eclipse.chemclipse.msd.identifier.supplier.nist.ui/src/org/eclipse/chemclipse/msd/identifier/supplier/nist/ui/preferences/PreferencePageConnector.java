...
public class PreferencePageConnector extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		addField(new IntegerFieldEditor(PreferenceSupplier.P_TIMEOUT_IN_MINUTES, "Timeout [min]", getFieldEditorParent()));
		addField(new IntegerFieldEditor(PreferenceSupplier.P_WAIT_IN_SECONDS, "Wait [s]", getFieldEditorParent()));
	}
