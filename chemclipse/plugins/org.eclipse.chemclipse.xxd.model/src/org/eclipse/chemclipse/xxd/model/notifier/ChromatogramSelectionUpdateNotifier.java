...
public class ChromatogramSelectionUpdateNotifier {
	 ...
	 * @param forceReload
	 */
	public static void fireUpdateChange(IChromatogramSelection chromatogramSelection, boolean forceReload) {
		 ...
		 */
		dynamicUpdateNotifier.updateSelection(chromatogramSelection, forceReload);
	}
}
