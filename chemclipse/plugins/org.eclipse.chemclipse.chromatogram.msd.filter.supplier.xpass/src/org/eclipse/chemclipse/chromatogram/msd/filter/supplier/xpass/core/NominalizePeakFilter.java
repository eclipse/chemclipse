...
public class NominalizePeakFilter implements IPeakFilter<NominalizeFilterSettings> {
	...
	@Override
	public <X extends IPeak> void filterIPeaks(CRUDListener<X, IPeakModel> listener, NominalizeFilterSettings configuration, MessageConsumer messageConsumer, IProgressMonitor monitor) throws IllegalArgumentException {
