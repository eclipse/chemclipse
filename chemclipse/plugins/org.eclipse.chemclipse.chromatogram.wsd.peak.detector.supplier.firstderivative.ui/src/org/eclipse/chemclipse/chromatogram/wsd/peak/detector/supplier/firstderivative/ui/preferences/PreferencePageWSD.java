 ...
 *******************************************************************************/
package org.eclipse.chemclipse.chromatogram.wsd.peak.detector.supplier.firstderivative.ui.preferences;
...
import org.eclipse.chemclipse.chromatogram.wsd.peak.detector.supplier.firstderivative.ui.Activator;
...
public class PreferencePageWSD extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		addField(new ComboFieldEditor(PreferenceSupplier.P_THRESHOLD_WSD, "Threshold", Threshold.getOptions(), getFieldEditorParent()));
