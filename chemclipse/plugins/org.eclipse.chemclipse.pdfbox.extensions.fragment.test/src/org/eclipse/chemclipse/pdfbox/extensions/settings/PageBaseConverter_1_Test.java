...
public class PageBaseConverter_1_Test extends TestCase {
	...
	public void test2a() {
		...
		assertEquals(-1.0f, converter.getPositionY(pdRectangle.getHeight(), -1.0f));
	}

	public void test2b() {

		assertEquals(0.0f, converter.getPositionY(pdRectangle.getHeight(), 0.0f));
	}
