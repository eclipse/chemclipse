 ...
 *******************************************************************************/
package org.eclipse.chemclipse.chromatogram.msd.filter.supplier.backfolding.ui.handlers;
...
import org.eclipse.chemclipse.chromatogram.msd.filter.supplier.backfolding.ui.modifier.FilterModifier;
...
public class FilterHandler implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start Backfolding Filter");
			/*
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Backfolding Filter finished");
		}
	}
