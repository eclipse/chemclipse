 ...
 *******************************************************************************/
package org.eclipse.chemclipse.msd.converter.supplier.animl.model;
...
public class VendorScan extends AbstractVendorMassSpectrum implements IVendorScan {
	 ...
	 * methods.
	 */
	private static final long serialVersionUID = 6893347373383890755L;
	...
	public IVendorScan makeDeepCopy() throws CloneNotSupportedException {
		...
		for(IIon ion : getIons()) {
			try {
				animlIon = new VendorIon(ion.getIon(), ion.getAbundance());
				massSpectrum.addIon(animlIon);
