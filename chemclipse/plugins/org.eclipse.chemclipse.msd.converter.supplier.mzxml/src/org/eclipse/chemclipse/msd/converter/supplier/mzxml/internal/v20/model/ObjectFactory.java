...
public class ObjectFactory {
	...
	private final static QName _SeparationTechnique_QNAME = new QName("http://sashimi.sourceforge.net/schema_revision/mzXML_2.0", "separationTechnique");
	...
	public ScansIntegration createScansIntegration() {

		return new ScansIntegration();
	}
	...
	@XmlElementDecl(namespace = "http://sashimi.sourceforge.net/schema_revision/mzXML_2.0", name = "separationTechnique")
