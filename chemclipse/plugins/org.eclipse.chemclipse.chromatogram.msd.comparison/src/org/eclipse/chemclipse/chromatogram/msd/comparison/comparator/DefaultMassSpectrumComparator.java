 ...
 *******************************************************************************/
package org.eclipse.chemclipse.chromatogram.msd.comparison.comparator;
...
import org.eclipse.chemclipse.chromatogram.msd.comparison.result.DefaultMassSpectrumComparisonResult;
...
public class DefaultMassSpectrumComparator extends AbstractMassSpectrumComparator implements IMassSpectrumComparator {
	...
	public IProcessingInfo compare(IScanMSD unknown, IScanMSD reference) {
		...
		if(!processingInfo.hasErrorMessages()) {
			...
			//
			IMassSpectrumComparisonResult massSpectrumComparisonResult = new DefaultMassSpectrumComparisonResult(matchFactor, reverseMatchFactor, matchFactorDirect, reverseMatchFactorDirect);
