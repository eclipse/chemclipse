 ...
 *******************************************************************************/
package org.eclipse.chemclipse.chromatogram.xxd.integrator.supplier.trapezoid.ui.handlers;

import java.lang.reflect.InvocationTargetException;

import javax.inject.Named;

import org.eclipse.chemclipse.chromatogram.xxd.integrator.supplier.trapezoid.ui.internal.handler.ChromatogramIntegratorRunnable;
...
public class ChromatogramIntegratorHandler implements EventHandler {

	private static final Logger logger = Logger.getLogger(ChromatogramIntegratorHandler.class);
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start Chromatogram and Baseline Integrator");
			IRunnableWithProgress runnable = new ChromatogramIntegratorRunnable(chromatogramSelection);
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Done: Chromatgram and Baseline integrated");
		}
	}
