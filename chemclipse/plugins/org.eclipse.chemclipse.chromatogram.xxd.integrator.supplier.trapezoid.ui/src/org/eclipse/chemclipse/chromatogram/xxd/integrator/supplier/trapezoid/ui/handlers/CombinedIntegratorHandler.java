...
import org.eclipse.chemclipse.chromatogram.xxd.integrator.supplier.trapezoid.ui.internal.handler.CombinedIntegratorRunnable;
...
public class CombinedIntegratorHandler implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start Combined Integrator");
			IRunnableWithProgress runnable = new CombinedIntegratorRunnable(chromatogramSelection);
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Done: Chromatgram, Baseline and Peaks integrated");
		}
	}
