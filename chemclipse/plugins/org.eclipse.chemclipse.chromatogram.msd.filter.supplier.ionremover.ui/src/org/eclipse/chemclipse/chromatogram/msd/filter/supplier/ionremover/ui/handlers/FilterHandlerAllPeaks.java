...
import org.eclipse.chemclipse.chromatogram.msd.filter.supplier.ionremover.ui.internal.handlers.FilterPeakRunnable;
...
public class FilterHandlerAllPeaks implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start Ion Remover Filter All Peaks");
			IRunnableWithProgress runnable = new FilterPeakRunnable(chromatogramSelection, false);
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Done: Ion Remover Filter applied");
		}
	}
