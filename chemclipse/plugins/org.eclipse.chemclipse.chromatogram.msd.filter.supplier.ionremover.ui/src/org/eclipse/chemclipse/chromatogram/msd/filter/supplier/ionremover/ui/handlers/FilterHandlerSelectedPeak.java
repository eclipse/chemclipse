...
public class FilterHandlerSelectedPeak implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start Ion Remover Peak Filter");
			IRunnableWithProgress runnable = new FilterPeakRunnable(chromatogramSelection, true);
