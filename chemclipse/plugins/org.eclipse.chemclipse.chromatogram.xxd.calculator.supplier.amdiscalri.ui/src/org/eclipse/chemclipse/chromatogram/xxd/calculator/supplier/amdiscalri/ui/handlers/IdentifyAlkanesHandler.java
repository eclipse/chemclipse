...
import org.eclipse.chemclipse.chromatogram.xxd.calculator.supplier.amdiscalri.ui.internal.runnables.IdentifyAlkanesRunnable;
...
public class IdentifyAlkanesHandler implements EventHandler {

	private static final Logger logger = Logger.getLogger(IdentifyAlkanesHandler.class);
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			try {
				 ...
				 */
				monitor.run(true, true, new IdentifyAlkanesRunnable(chromatogramSelection));
