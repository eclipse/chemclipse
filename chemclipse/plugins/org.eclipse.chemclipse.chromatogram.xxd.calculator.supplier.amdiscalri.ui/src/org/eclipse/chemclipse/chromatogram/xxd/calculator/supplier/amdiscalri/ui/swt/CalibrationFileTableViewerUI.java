...
public class CalibrationFileTableViewerUI extends ExtendedTableViewer {

	private String[] titles = {"Retention Time (Minutes)", "Retention Index", "Name"};
	private int[] bounds = {200, 200, 200};

	public CalibrationFileTableViewerUI(Composite parent) {
		super(parent);
		initialize();
	}

	public CalibrationFileTableViewerUI(Composite parent, int style) {
		super(parent, style);
		initialize();
	}
