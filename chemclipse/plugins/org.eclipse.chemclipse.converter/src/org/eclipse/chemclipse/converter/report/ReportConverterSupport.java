...
public class ReportConverterSupport implements IReportConverterSupport {
	...
	@Override
	public void add(final IReportSupplier supplier) {
	...
	public String getConverterId(final int index) throws NoConverterAvailableException {
		...
		IReportSupplier supplier = suppliers.get(index);
	...
	@Override
	public IReportSupplier getSupplier(String id) throws NoConverterAvailableException {

		IReportSupplier instance = null;
		exitloop:
		for(IReportSupplier supplier : suppliers) {
