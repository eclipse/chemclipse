 ...
 * @author eselmeister
 */
public class SeriesConverter_17_Test extends XICChromatogramSelectionTestCase {
	...
	public void testSize_1() {
		...
		series = SeriesConverterMSD.convertChromatogram(chromatogramSelection, selectedIons, false, Sign.POSITIVE);
		assertEquals("Size", 2, series.getMultipleSeries().size());
	}
