 ...
 * @author eselmeister
 */
public class SeriesConverter_18_Test extends XICChromatogramSelectionTestCase {
	...
	protected void setUp() throws Exception {
		...
		if(chromatogramSelection instanceof ChromatogramSelectionMSD) {
			...
			selection.setStartRetentionTime(7000);
			selection.setStopRetentionTime(8000);
		}
	...
	public void testConvertChromatogramOverview_1() {
		...
		series = SeriesConverterMSD.convertChromatogram(chromatogramSelection, selectedIons, true, Sign.POSITIVE);
		assertEquals("XMin", 7000.0d, series.getXMin());
	}
	...
	public void testConvertChromatogramOverview_3() {
		...
		series = SeriesConverterMSD.convertChromatogram(chromatogramSelection, selectedIons, true, Sign.POSITIVE);
		assertEquals("YMin", 5000.0d, series.getYMin());
	}

	public void testConvertChromatogramOverview_4() {

		series = SeriesConverterMSD.convertChromatogram(chromatogramSelection, selectedIons, true, Sign.POSITIVE);
		assertEquals("YMax", 608000.0d, series.getYMax());
	}
}
