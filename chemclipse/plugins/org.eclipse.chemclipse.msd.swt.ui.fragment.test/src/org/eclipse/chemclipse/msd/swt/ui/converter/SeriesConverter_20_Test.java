 ...
 * @author eselmeister
 */
public class SeriesConverter_20_Test extends XICChromatogramSelectionTestCase {
	...
	public void testConvertChromatogramOverview_1() {
		...
		series = SeriesConverterMSD.convertChromatogramByExcludedIons(chromatogramSelection, excludedIons, Sign.NEGATIVE);
	...
	public void testConvertChromatogramOverview_3() {
		...
		series = SeriesConverterMSD.convertChromatogramByExcludedIons(chromatogramSelection, excludedIons, Sign.NEGATIVE);
		assertEquals("YMin", -1153450.0d, series.getYMin());
	}
