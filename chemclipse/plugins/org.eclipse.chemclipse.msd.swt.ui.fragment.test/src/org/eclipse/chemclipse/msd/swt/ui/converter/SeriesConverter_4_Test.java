 ...
 * @author eselmeister
 */
public class SeriesConverter_4_Test extends ChromatogramOverviewTestCase {
	...
	public void testConvertChromatogramOverview_1() {
		...
		series = SeriesConverter.convertChromatogramOverview(chromatogramOverview, Sign.NEGATIVE, true);
	...
	public void testConvertChromatogramOverview_3() {
		...
		series = SeriesConverter.convertChromatogramOverview(chromatogramOverview, Sign.NEGATIVE, true);
		assertEquals("YMin", -1712850.0d, series.getYMin());
	}
