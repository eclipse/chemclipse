 ...
 * @author eselmeister
 */
public class SeriesConverter_12_Test extends ChromatogramSelectionsTestCase {
	...
	public void testConvertChromatogramOverview_1() {
		...
		series = SeriesConverter.convertChromatograms(chromatogramSelections, Sign.NEGATIVE, offset, true);
		assertEquals("XMin", 3500.0d, series.getXMin());
	}
	...
	public void testConvertChromatogramOverview_3() {
		...
		series = SeriesConverter.convertChromatograms(chromatogramSelections, Sign.NEGATIVE, offset, true);
		assertEquals("YMin", -1292450.0d, series.getYMin());
	}

	public void testConvertChromatogramOverview_4() {

		series = SeriesConverter.convertChromatograms(chromatogramSelections, Sign.NEGATIVE, offset, true);
		assertEquals("YMax", -15000.0d, series.getYMax());
	}
}
