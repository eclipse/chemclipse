 ...
 * @author eselmeister
 */
public class SeriesConverter_27_Test extends PeakTestCase {
	...
	public void testConvertPeak_1() {
		...
		series = SeriesConverterMSD.convertPeak(peaks, false, Sign.POSITIVE, offset);
	...
	public void testConvertPeak_4() {
		 ...
		 */
		series = SeriesConverterMSD.convertPeak(peaks, false, Sign.POSITIVE, offset);
		assertEquals("YMax", 15231.0d, series.getYMax());
	}
}
