...
public class ValueParserSupport_5_Test extends TestCase {
	...
	public void test8() {
		...
		assertEquals(28.3f, support.parseFloat(values, 0));
	}

	public void test9() {

		assertEquals(28.3f, support.parseFloat(values, 0, 0.0f));
	}

	public void test10() {

		assertEquals(28.3f, support.parseFloat(values, 0, 1.0f));
	}

	public void test11() {

		assertEquals(28.3d, support.parseDouble(values, 0));
	}

	public void test12() {

		assertEquals(28.3d, support.parseDouble(values, 0, 0.0d));
	}

	public void test13() {

		assertEquals(28.3d, support.parseDouble(values, 0, 1.0d));
	}
}
