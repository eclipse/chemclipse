 ...
 *******************************************************************************/
package org.eclipse.chemclipse.chromatogram.msd.filter.supplier.coda.ui.handlers;
...
import org.eclipse.chemclipse.chromatogram.msd.filter.supplier.coda.ui.modifier.FilterModifier;
...
public class FilterHandler implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start CODA Filter");
			/*
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "CODA Filter finished");
		}
	}
