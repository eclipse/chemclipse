...
import org.eclipse.chemclipse.msd.classifier.supplier.molpeak.ui.runnables.PeakIdentifierRunnable;
...
public class IdentifySelectedPeakHandler implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			 ...
			 */
			IRunnableWithProgress runnable = new PeakIdentifierRunnable(chromatogramSelection);
