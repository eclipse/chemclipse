...
import org.eclipse.chemclipse.msd.classifier.supplier.molpeak.ui.runnables.PeakListIdentifierRunnable;
...
public class IdentifyAllPeaksHandler implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start the mol peak identification.");
			/*
			 * Do the operation.<br/> Open a progress monitor dialog.
			 */
			IRunnableWithProgress runnable = new PeakListIdentifierRunnable(chromatogramSelection);
			runOperation(display, runnable);
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Done: All Peaks identified");
		}
	}
