...
import org.eclipse.chemclipse.chromatogram.msd.quantitation.supplier.chemclipse.ui.internal.runnables.QuantifySelectedPeakISTDRunnable;
...
public class QuantifySelectedPeakISTDHandler implements EventHandler {

	private static final Logger logger = Logger.getLogger(QuantifySelectedPeakISTDHandler.class);
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			QuantifySelectedPeakISTDRunnable runnable = new QuantifySelectedPeakISTDRunnable(chromatogramSelection);
