...
import org.eclipse.chemclipse.chromatogram.msd.quantitation.supplier.chemclipse.ui.internal.runnables.QuantifyPeakRunnableISTD;
...
public class QuantifyPeakHandlerISTD implements EventHandler {

	private static final Logger logger = Logger.getLogger(QuantifyPeakHandlerISTD.class);
	...
	public void execute(Shell shell, @Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			QuantifyPeakRunnableISTD runnable = new QuantifyPeakRunnableISTD(chromatogramSelection);
