...
import org.eclipse.chemclipse.chromatogram.msd.quantitation.supplier.chemclipse.ui.internal.runnables.QuantifyPeaksRunnableESTD;
...
public class QuantifyPeaksHandlerESTD implements EventHandler {

	private static final Logger logger = Logger.getLogger(QuantifyPeaksHandlerESTD.class);
	...
	public void execute(Shell shell, @Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			QuantifyPeaksRunnableESTD runnable = new QuantifyPeaksRunnableESTD(chromatogramSelection);
