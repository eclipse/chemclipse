...
public class ChromatogramSelection_2_Test extends TestCase {
	...
	public void testGetStartAbundance_1() {
		...
		assertEquals("StartAbundance", 0.5f, selection.getStartAbundance());
	}

	public void testGetStopAbundance_1() {

		selection.setStopAbundance(250000.0f);
		assertEquals("StopAbundance", 250000.0f, selection.getStopAbundance());
	}
}
