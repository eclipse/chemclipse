...
public class TotalIonSignalsModifier_3_Test extends TestCase {
	...
	public void testGetPoint_1() {
		...
		assertEquals("total signal", 0.014567601f, s1.getTotalSignal());
	}
	...
	public void testGetPoint_2() {
		...
		int scan = 4;
		ITotalScanSignal s1 = signals.getTotalScanSignal(scan);
		assertEquals("total signal", 0.075397170f, s1.getTotalSignal());
	}
	...
	public void testGetPoint_3() {
		...
		int scan = 12;
		ITotalScanSignal s1 = signals.getTotalScanSignal(scan);
		assertEquals("total signal", 0.00001904768f, s1.getTotalSignal());
	}
}
