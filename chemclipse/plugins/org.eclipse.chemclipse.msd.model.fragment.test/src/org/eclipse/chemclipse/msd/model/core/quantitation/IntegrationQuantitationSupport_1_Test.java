...
public class IntegrationQuantitationSupport_1_Test extends QuantitationCalculator_TIC_TestCase {
	...
	private IntegrationQuantitationSupport support;

	@Override
	protected void setUp() throws Exception {

		super.setUp();
		support = new IntegrationQuantitationSupport(getReferencePeakMSD_TIC_1());
	}
	...
	public void testIsTheTotalSignalIntegrated_1() {
		...
		assertTrue(support.isTheTotalSignalIntegrated());
	}
