 ...
 * @author eselmeister
 */
public class MassSpectrum_14_Test extends TestCase {
	...
	public void testGetNormalizationBase_1() {
		...
		assertEquals("normalizationBase", 100.0f, massSpectrum.getNormalizationBase());
	}
	...
	public void testGetTotalSignal_1() {
		...
		assertEquals("getTotalSignal", 139.471472f, massSpectrum.getTotalSignal());
	}
	...
	public void testGetExtractedIonSignal_2() {
		...
		assertEquals("getExtractedIonSignal", 13.475312f, massSpectrum.getExtractedIonSignal(25, 120).getAbundance(104));
	}

	public void testGetExtractedIonSignal_3() {

		assertEquals("getExtractedIonSignal", 100.0f, massSpectrum.getExtractedIonSignal(25, 120).getAbundance(33));
	}

	public void testGetExtractedIonSignal_4() {

		assertEquals("getExtractedIonSignal", 13.475312f, massSpectrum.getExtractedIonSignal(25, 120).getAbundance(106));
	}
	...
	public void testGetBasePeakAbundance_1() {
		...
		assertEquals("getBasePeakAbundance", 100.0f, massSpectrum.getBasePeakAbundance());
	}

	public void testGetHighestAbundance_1() {

		assertEquals("getHighestAbundance", 100.0f, massSpectrum.getHighestAbundance().getAbundance());
	}
	...
	public void testGetHighestIon_1() {
		...
		assertEquals("getHighestIon", 13.475312f, massSpectrum.getHighestIon().getAbundance());
	}
	...
	public void testGetLowestAbundance_1() {
		...
		assertEquals("getLowestAbundance", 3.7057545f, massSpectrum.getLowestAbundance().getAbundance());
	}
	...
	public void testGetLowestIon_1() {
		...
		assertEquals("getLowestIon", 3.7057545f, massSpectrum.getLowestIon().getAbundance());
	}
	...
	public void testGetIonBounds_1() {
		...
		assertEquals("getLowestIon().getAbundance()", 3.7057545f, bounds.getLowestIon().getAbundance());
		assertEquals("getLowestIon().getIon()", 28.200000762939453d, bounds.getLowestIon().getIon());
		assertEquals("getHighestIon().getAbundance()", 13.475312f, bounds.getHighestIon().getAbundance());
