 ...
 * DefaultIon(45.5f, 90200.8f); // insert it twice with a higher
 * abundance + massSpectrum.addIon(ion); + ion = new
 ...
 * @author eselmeister
 */
public class MassSpectrum_9_Test extends TestCase {
	...
	public void getExtractedIonSignal_4() {
		...
		assertEquals("getExtractedIonSignal", 90200.8f, massSpectrum.getExtractedIonSignal(40, 120).getAbundance(46));
	}
	...
	public void testGetLowestIon_1() {
		...
		assertEquals("getLowestIon", 90200.8f, massSpectrum.getLowestIon().getAbundance());
	}
	...
	public void testGetIonBounds_1() {
		...
		assertEquals("getLowestIon().getAbundance()", 90200.8f, bounds.getLowestIon().getAbundance());
	...
	public void testGetIon_1() {
		...
		try {
			...
			assertEquals("getIon(46) abundance", 90200.8f, ion.getAbundance());
