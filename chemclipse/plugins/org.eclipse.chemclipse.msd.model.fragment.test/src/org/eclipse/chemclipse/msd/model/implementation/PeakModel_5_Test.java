...
public class PeakModel_5_Test extends PeakModelTestCase {
	...
	public void testGetBackgroundAbundance_1() {
		...
		assertEquals("GetBackgroundAbundance", 100000.0f, peakModel.getBackgroundAbundance(1500));
	}

	public void testGetBackgroundAbundance_2() {

		assertEquals("GetBackgroundAbundance", 55162.0f, peakModel.getBackgroundAbundance(7800));
	}

	public void testGetBackgroundAbundance_3() {

		assertEquals("GetBackgroundAbundance", 360.0f, peakModel.getBackgroundAbundance(15500));
	}

	public void testGetBackgroundAbundance_4() {

		assertEquals("GetBackgroundAbundance", 43062.855f, peakModel.getBackgroundAbundance());
	}
