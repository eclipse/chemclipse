...
public class AMDISConverter_2_ITest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		File file = new File(TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CALIBRATION_CAL_2));
