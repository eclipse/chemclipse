...
public class DeleteAllScanIdentificationsHandler extends AbstractIdentificationsHandler implements EventHandler {

	@Execute
	public void execute(UISynchronize uiSynchronize, final @Named(IServiceConstants.ACTIVE_SHELL) Shell shell) {

		deleteIdentifications(shell, "Delete All Identifications (Scans)", false, false, true);
	}
