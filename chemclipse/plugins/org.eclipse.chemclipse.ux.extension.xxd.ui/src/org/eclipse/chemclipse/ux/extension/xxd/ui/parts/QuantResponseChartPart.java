...
public class QuantResponseChartPart extends AbstractDataUpdateSupport implements IDataUpdateSupport {

	private QuantResponseChartUI quantResponseChartUI;

	@Inject
	public QuantResponseChartPart(Composite parent, MPart part) {
		super(part);
		quantResponseChartUI = new QuantResponseChartUI(parent, SWT.NONE);
	}
