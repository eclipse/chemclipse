...
public class PreferenceSupplier extends AbstractPreferenceSupplier implements IPreferenceSupplier {
	...
	public static final String DEF_STACK_POSITION_OVERLAY_XIR = PartSupport.PARTSTACK_BOTTOM_RIGHT;
	...
	public void initializeDefaults() {
		...
		putDefault(P_STACK_POSITION_OVERLAY_XIR, DEF_STACK_POSITION_OVERLAY_XIR);
		...
		putDefault(P_SHOW_DATA_ISD, DEF_SHOW_DATA_ISD);
		...
		putDefault(P_SHOW_DATA_XIR, DEF_SHOW_DATA_XIR);
