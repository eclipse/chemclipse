...
public class ScanEditorNMR extends AbstractDataUpdateSupport implements IChemClipseEditor, IDataUpdateSupport {
	...
	public ScanEditorNMR(DataType dataType, Composite parent, MPart part, MDirtyable dirtyable, Shell shell) {
		super(part);
		//
		this.part = part;
