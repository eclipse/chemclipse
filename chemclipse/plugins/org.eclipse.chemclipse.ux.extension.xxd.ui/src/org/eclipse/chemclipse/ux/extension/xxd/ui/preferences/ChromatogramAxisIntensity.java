...
public class ChromatogramAxisIntensity extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		addField(new StringFieldEditor(PreferenceConstants.P_FORMAT_Y_AXIS_INTENSITY, "Format:", getFieldEditorParent()));
		...
		if(Display.isSystemDarkTheme()) {
			addField(new ColorFieldEditor(PreferenceConstants.P_COLOR_Y_AXIS_INTENSITY_DARKTHEME, "Color:", getFieldEditorParent()));
		} else {
