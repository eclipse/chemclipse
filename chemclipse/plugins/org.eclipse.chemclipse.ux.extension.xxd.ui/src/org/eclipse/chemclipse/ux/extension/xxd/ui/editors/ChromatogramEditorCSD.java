...
public class ChromatogramEditorCSD extends AbstractChromatogramEditor {
	...
	@Inject
	public ChromatogramEditorCSD(Composite parent, MPart part, MDirtyable dirtyable) {
		super(DataType.CSD, parent, part, dirtyable);
	}
}
