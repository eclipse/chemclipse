...
public class ScanNMRImportRunnable implements IRunnableWithProgress {
	...
	//
	private File file;
	private IComplexSignalMeasurement<?> measurementNMR = null;

	public ScanNMRImportRunnable(File file) {
		this.file = file;
	}

	public IComplexSignalMeasurement<?> getScanNMR() {
	...
	public void run(final IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
		...
		try {
			...
			IProcessingInfo<IComplexSignalMeasurement<?>> processingInfo = ScanConverterNMR.convert(file, monitor);
