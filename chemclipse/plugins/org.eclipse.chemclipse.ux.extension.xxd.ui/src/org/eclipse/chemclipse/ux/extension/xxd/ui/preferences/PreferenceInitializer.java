...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(PreferenceConstants.P_STACK_POSITION_CHROMATOGRAM_STATISTICS, PreferenceConstants.DEF_STACK_POSITION_CHROMATOGRAM_STATISTICS);
		...
		store.setDefault(PreferenceConstants.P_STACK_POSITION_COLUMN_INDICES, PreferenceConstants.DEF_STACK_POSITION_COLUMN_INDICES);
		store.setDefault(PreferenceConstants.P_STACK_POSITION_FLAVOR_MARKER, PreferenceConstants.DEF_STACK_POSITION_FLAVOR_MARKER);
		store.setDefault(PreferenceConstants.P_STACK_POSITION_LITERATURE, PreferenceConstants.DEF_STACK_POSITION_LITERATURE);
		store.setDefault(PreferenceConstants.P_STACK_POSITION_CAS_NUMBERS, PreferenceConstants.DEF_STACK_POSITION_CAS_NUMBERS);
		...
		store.setDefault(PreferenceConstants.P_SCAN_IDENTIFER, PreferenceConstants.DEF_SCAN_IDENTIFER);
		//
	...
	public static IPreferenceStore initializeChromatogramDefaults(IPreferenceStore store) {
		...
		//
		store.setDefault(PreferenceConstants.P_COLOR_CHROMATOGRAM_PEAKS_ACTIVE_NORMAL, PreferenceConstants.DEF_COLOR_CHROMATOGRAM_PEAKS_ACTIVE_NORMAL);
		store.setDefault(PreferenceConstants.P_COLOR_CHROMATOGRAM_PEAKS_ACTIVE_NORMAL_TARGETS_HIDDEN, PreferenceConstants.DEF_COLOR_CHROMATOGRAM_PEAKS_ACTIVE_NORMAL_TARGETS_HIDDEN);
		store.setDefault(PreferenceConstants.P_COLOR_CHROMATOGRAM_PEAKS_INACTIVE_NORMAL, PreferenceConstants.DEF_COLOR_CHROMATOGRAM_PEAKS_INACTIVE_NORMAL);
		store.setDefault(PreferenceConstants.P_COLOR_CHROMATOGRAM_PEAKS_ACTIVE_ISTD, PreferenceConstants.DEF_COLOR_CHROMATOGRAM_PEAKS_ACTIVE_ISTD);
		store.setDefault(PreferenceConstants.P_COLOR_CHROMATOGRAM_PEAKS_ACTIVE_ISTD_TARGETS_HIDDEN, PreferenceConstants.DEF_COLOR_CHROMATOGRAM_PEAKS_ACTIVE_ISTD_TARGETS_HIDDEN);
		store.setDefault(PreferenceConstants.P_COLOR_CHROMATOGRAM_PEAKS_INACTIVE_ISTD, PreferenceConstants.DEF_COLOR_CHROMATOGRAM_PEAKS_INACTIVE_ISTD);
		//
		store.setDefault(PreferenceConstants.P_CHROMATOGRAM_ACTIVE_TARGET_LABEL_FONT_COLOR, PreferenceConstants.DEF_CHROMATOGRAM_ACTIVE_TARGET_LABEL_FONT_COLOR);
		store.setDefault(PreferenceConstants.P_CHROMATOGRAM_INACTIVE_TARGET_LABEL_FONT_COLOR, PreferenceConstants.DEF_CHROMATOGRAM_INACTIVE_TARGET_LABEL_FONT_COLOR);
		store.setDefault(PreferenceConstants.P_CHROMATOGRAM_ID_TARGET_LABEL_FONT_COLOR, PreferenceConstants.DEF_CHROMATOGRAM_ID_TARGET_LABEL_FONT_COLOR);
		//
		store.setDefault(PreferenceConstants.P_CHROMATOGRAM_ACTIVE_TARGET_LABEL_FONT_DARK_COLOR, PreferenceConstants.DEF_CHROMATOGRAM_ACTIVE_TARGET_LABEL_FONT_DARK_COLOR);
		store.setDefault(PreferenceConstants.P_CHROMATOGRAM_INACTIVE_TARGET_LABEL_FONT_DARK_COLOR, PreferenceConstants.DEF_CHROMATOGRAM_INACTIVE_TARGET_LABEL_FONT_DARK_COLOR);
		store.setDefault(PreferenceConstants.P_CHROMATOGRAM_ID_TARGET_LABEL_FONT_DARK_COLOR, PreferenceConstants.DEF_CHROMATOGRAM_ID_TARGET_LABEL_FONT_DARK_COLOR);
		//
		...
		store.setDefault(PreferenceConstants.P_CHROMATOGRAM_EXTEND_Y, PreferenceConstants.DEF_CHROMATOGRAM_EXTEND_Y);
		...
		store.setDefault(PreferenceConstants.P_CHROMATOGRAM_TRANSFER_NAME_TO_REFERENCES_HEADER_FIELD, PreferenceConstants.DEF_CHROMATOGRAM_TRANSFER_NAME_TO_REFERENCES_HEADER_FIELD);
	...
	public static IPreferenceStore initializeOverlayDefaults(IPreferenceStore store) {
		...
		store.setDefault(PreferenceConstants.P_OVERLAY_ADD_TYPE_INFO, PreferenceConstants.DEF_OVERLAY_ADD_TYPE_INFO);
