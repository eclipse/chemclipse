...
public class PeakDetailsPart extends AbstractDataUpdateSupport implements IDataUpdateSupport {
	...
	private ExtendedPeakDetailsUI extendedPeakListUI;

	@Inject
	public PeakDetailsPart(Composite parent, MPart part) {
		super(part);
		extendedPeakListUI = new ExtendedPeakDetailsUI(parent);
	}
	...
	public void updateObjects(List<Object> objects, String topic) {
		...
		if(objects.size() == 1) {
			...
			if(object instanceof IPeak) {
				extendedPeakListUI.update((IPeak)object);
			} else {
				extendedPeakListUI.update(null);
			}
		}
	}
}
