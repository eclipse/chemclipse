 ...
 * The selected accurate ions will be drawn separately.
 * 
 * @author eselmeister
 */
	...
	public void setViewSeries() {
		...
		if(storedChromatogramSelection instanceof IChromatogramSelectionMSD) {
			...
			if(selectedIons != null && selectedIons.size() > 0) {
				/*
				 * Convert an accurate selection.
				 */
				IMultipleSeries multipleSeries = SeriesConverterMSD.convertChromatogramExact(chromatogramSelection, selectedIons, false, Sign.POSITIVE);
