 ...
 */
public class PinnedMassSpectrumUIWithLabel extends Composite implements IMassSpectrumSelectionUpdateNotifier {
	...
	public void update(IScanMSD massSpectrum, boolean forceReload) {
		...
		if(massSpectrum != null && !isPinned) {
			...
			if(this.massSpectrum != massSpectrum) {
				...
				massSpectrumUI.update(this.massSpectrum, forceReload);
			}
		}
	}
