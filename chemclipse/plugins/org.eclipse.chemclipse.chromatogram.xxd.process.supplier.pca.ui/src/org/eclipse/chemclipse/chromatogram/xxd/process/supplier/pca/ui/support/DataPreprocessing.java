...
public class DataPreprocessing {
	...
	public DataPreprocessing(Composite composite, Object layoutData) {
		this(composite, layoutData, new PcaScalingData(false));
	}

	public DataPreprocessing(Composite composite, Object layoutData, PcaScalingData pcaNormalizationData) {
	}
