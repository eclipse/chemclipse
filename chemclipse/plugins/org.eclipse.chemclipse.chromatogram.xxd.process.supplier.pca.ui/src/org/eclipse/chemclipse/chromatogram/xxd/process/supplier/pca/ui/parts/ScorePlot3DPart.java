...
public class ScorePlot3DPart extends AbstractPartPCA<ExtendedScorePlot3D> {

	private static final String TOPIC = Activator.TOPIC_PCA_EVALUATION_LOAD;

	@Inject
	public ScorePlot3DPart(Composite parent) {

		super(parent, TOPIC);
	}

	@Override
	protected ExtendedScorePlot3D createControl(Composite parent) {

		return new ExtendedScorePlot3D(parent, SWT.NONE);
	}
