...
public class MassSetGroupNamesWizardPage extends WizardPage {
	...
	public MassSetGroupNamesWizardPage(String pageName) {
		super(pageName);
	...
	public void createControl(Composite parent) {
		...
		IPcaInputWizard inputWizard = (IPcaInputWizard)getWizard();
