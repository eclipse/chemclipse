...
public class PreferencePageUnknownWSD extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		addField(new IntegerFieldEditor(PreferenceSupplier.P_NUMBER_OF_WAVELENGTH_UNKNOWN + POSTFIX, "Number of wavelength", PreferenceSupplier.MIN_NUMBER_OF_WAVELENGTH, PreferenceSupplier.MAX_NUMBER_OF_WAVELENGTH, getFieldEditorParent()));
