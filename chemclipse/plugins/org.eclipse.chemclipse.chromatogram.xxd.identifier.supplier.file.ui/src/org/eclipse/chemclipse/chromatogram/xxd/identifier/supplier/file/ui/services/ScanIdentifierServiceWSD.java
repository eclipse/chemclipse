...
import org.eclipse.chemclipse.chromatogram.xxd.identifier.supplier.file.ui.preferences.PreferencePageUnknownWSD;
...
public class ScanIdentifierServiceWSD implements IScanIdentifierService {
	...
	public Class<? extends IWorkbenchPreferencePage> getPreferencePage() {
		...
		return PreferencePageUnknownWSD.class;
	}
}