...
public class PreferencePageUnknownMSD extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	private static final String POSTFIX = PreferenceSupplier.POSTFIX_MSD;

	public PreferencePageUnknownMSD() {
	...
	public void createFieldEditors() {
		...
		addField(new ExtendedIntegerFieldEditor(PreferenceSupplier.P_NUMBER_OF_MZ_UNKNOWN + POSTFIX, "Number of m/z", PreferenceSupplier.MIN_NUMBER_OF_MZ, PreferenceSupplier.MAX_NUMBER_OF_MZ, getFieldEditorParent()));
