...
public class PreferencePageUnknownMSD extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		addField(new IntegerFieldEditor(PreferenceSupplier.P_NUMBER_OF_MZ_UNKNOWN + POSTFIX, "Number of m/z", PreferenceSupplier.MIN_NUMBER_OF_MZ, PreferenceSupplier.MAX_NUMBER_OF_MZ, getFieldEditorParent()));
