		...
		if(eventBroker != null) {
			...
			EventHandler eventHandlerFileOverview = new EventHandler() {
				...
				public void handleEvent(Event event) {
					...
					try {
						Object object = event.getProperty(IChemClipseEvents.PROPERTY_CHROMATOGRAM_WSD_RAWFILE);
			...
			eventBroker.subscribe(IChemClipseEvents.TOPIC_CHROMATOGRAM_WSD_UPDATE_RAWFILE, eventHandlerFileOverview);
			/*
			...
			EventHandler eventHandlerInstanceOverview = new EventHandler() {
				...
				public void handleEvent(Event event) {
					...
					try {
						Object object = event.getProperty(IChemClipseEvents.PROPERTY_CHROMATOGRAM_WSD_OVERVIEW);
			...
			eventBroker.subscribe(IChemClipseEvents.TOPIC_CHROMATOGRAM_WSD_UPDATE_OVERVIEW, eventHandlerInstanceOverview);
		}
	}
