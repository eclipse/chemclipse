 ...
 *******************************************************************************/
package org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.scanremover.ui.handlers;

import java.lang.reflect.InvocationTargetException;

import javax.inject.Named;

import org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.scanremover.ui.modifier.FilterModifierCleaner;
...
public class FilterHandlerCleaner implements EventHandler {

	private static final Logger logger = Logger.getLogger(FilterHandlerCleaner.class);
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start Remove Empty Scans Filter");
			/*
			 * Do the operation.<br/> Open a progress monitor dialog.
			 */
			IRunnableWithProgress runnable = null;
			if(chromatogramSelection != null) {
				runnable = new FilterModifierCleaner(chromatogramSelection);
			}
			/*
			 * 
			 */
			if(runnable != null) {
				...
				StatusLineLogger.setInfo(InfoType.MESSAGE, "Remove Empty Scans Filter finished");
			}
		}
	}
