...
public class FilterModifierCleaner extends AbstractChromatogramProcessor implements IRunnableWithProgress {

	private static final String DESCRIPTION = "Remove Empty Scans";
	private static final String FILTER_ID = "org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.removeemptyscans";

	public FilterModifierCleaner(IChromatogramSelection chromatogramSelection) {
	...
	public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
		 ...
		 */
		try {
			monitor.beginTask("Remove Empty Scans Filter", IProgressMonitor.UNKNOWN);
