...
import org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.scanremover.ui.modifier.FilterModifierRemover;
...
public class FilterHandlerRemover implements EventHandler {

	private static final Logger logger = Logger.getLogger(FilterHandlerRemover.class);
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start Scan Remover Filter");
			/*
			 * Do the operation.<br/> Open a progress monitor dialog.
			 */
			IRunnableWithProgress runnable = null;
			if(chromatogramSelection != null) {
				runnable = new FilterModifierRemover(chromatogramSelection);
			}
			/*
			 * 
			 */
			if(runnable != null) {
				...
				StatusLineLogger.setInfo(InfoType.MESSAGE, "Scan Remover Filter finished");
			}
		}
	}
