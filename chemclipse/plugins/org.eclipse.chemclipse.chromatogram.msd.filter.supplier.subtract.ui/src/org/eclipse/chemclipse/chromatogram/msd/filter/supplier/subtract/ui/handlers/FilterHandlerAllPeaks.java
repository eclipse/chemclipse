...
import org.eclipse.chemclipse.chromatogram.msd.filter.supplier.subtract.ui.modifier.FilterModifierPeak;
...
public class FilterHandlerAllPeaks implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null && chromatogramSelection.getSelectedPeak() != null) {
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start MS Subtract Filter on all Peaks");
			/*
			 * Do the operation.<br/> Open a progress monitor dialog.
			 */
			final Display display = Display.getCurrent();
			IRunnableWithProgress runnable = new FilterModifierPeak(chromatogramSelection, false);
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "MS Subtract Filter on all Peaks finished");
		}
	}
