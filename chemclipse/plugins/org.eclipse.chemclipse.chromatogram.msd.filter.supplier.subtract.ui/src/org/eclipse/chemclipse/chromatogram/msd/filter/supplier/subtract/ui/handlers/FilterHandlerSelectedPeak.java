...
public class FilterHandlerSelectedPeak implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null && chromatogramSelection.getSelectedPeak() != null) {
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start MS Subtract Filter on Selected Peak");
			/*
			 * Do the operation.<br/> Open a progress monitor dialog.
			 */
			final Display display = Display.getCurrent();
			IRunnableWithProgress runnable = new FilterModifierPeak(chromatogramSelection, true);
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "MS Subtract Filter on Selected Peak finished");
		}
	}
