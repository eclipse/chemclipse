...
public interface IPeakReader {
	 ...
	 * @throws IOException
	 */
	IProcessingInfo<IPeaks<?>> read(File file, IProgressMonitor monitor) throws FileNotFoundException, FileIsNotReadableException, FileIsEmptyException, IOException;
}
