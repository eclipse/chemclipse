...
public class PeakDetector extends AbstractPeakDetectorMSD {
	...
	private IPeakRanges getPeaksFromDeconvolution(IAllIonSignals allIonSignals, IPeakRanges peakRanges, ChromatogramFilterSettings filterSettings, IDurbinWatsonClassifierResult durbinWatsonClassifierResult, IProgressMonitor monitor) {
		...
		//
		IMarkedIons excludedIons = new MarkedIons(IMarkedIons.IonMarkMode.INCLUDE);
		IMarkedIons excludedIons2 = new MarkedIons(IMarkedIons.IonMarkMode.INCLUDE);
		IMarkedIons excludedIons3 = new MarkedIons(IMarkedIons.IonMarkMode.INCLUDE);
		IMarkedIons excludedIons4 = new MarkedIons(IMarkedIons.IonMarkMode.INCLUDE);
		IMarkedIons excludedIons5 = new MarkedIons(IMarkedIons.IonMarkMode.INCLUDE);
		IMarkedIons excludedIonsPeak2_1 = new MarkedIons(IMarkedIons.IonMarkMode.INCLUDE);
		IMarkedIons excludedIonsPeak2_2 = new MarkedIons(IMarkedIons.IonMarkMode.INCLUDE);
		for(IIonSignals ionSignal : allIonSignals.getIonSignals()) {
