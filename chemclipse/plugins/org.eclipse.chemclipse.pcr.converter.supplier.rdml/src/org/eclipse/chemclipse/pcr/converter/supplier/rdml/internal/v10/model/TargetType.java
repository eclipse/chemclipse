...
/**
 * A target is a defined PCR reaction. PCR reactions at the same gene
 * which differ in primer sequences are considered different samples.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "targetType", propOrder = {"description", "documentation", "xRef", "type", "amplificationEfficiency", "detectionLimit", "dyeId", "sequences", "commercialAssay"})
public class TargetType {
	...
	public void setDyeId(String value) {
