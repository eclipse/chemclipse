...
@XmlType(name = "targetType", propOrder = {"description", "documentation", "xRef", "type", "amplificationEfficiencyMethod", "amplificationEfficiency", "amplificationEfficiencySE", "meltingTemperature", "detectionLimit", "dyeId", "sequences", "commercialAssay"})
public class TargetType {
	...
	protected Float amplificationEfficiencySE;
	protected Float meltingTemperature;
	...
	public Float getAmplificationEfficiencySE() {

		return amplificationEfficiencySE;
	}

	public void setAmplificationEfficiencySE(Float value) {

		this.amplificationEfficiencySE = value;
	}
	...
	public void setMeltingTemperature(Float value) {
