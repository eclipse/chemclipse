...
@XmlType(name = "", propOrder = {"dateMade", "dateUpdated", "id", "experimenter", "documentation", "sample", "target", "thermalCyclingConditions", "experiment", "thirdPartyExtensions"})
...
public class Rdml {
	...
	protected ThirdPartyExtensionsType thirdPartyExtensions;
	...
	public ThirdPartyExtensionsType getThirdPartyExtensions() {

		return thirdPartyExtensions;
	}

	public void setThirdPartyExtensions(ThirdPartyExtensionsType value) {

		this.thirdPartyExtensions = value;
	}
