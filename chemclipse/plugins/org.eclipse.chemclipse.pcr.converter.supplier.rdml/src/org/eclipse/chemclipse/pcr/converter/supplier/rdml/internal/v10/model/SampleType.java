...
/**
 * A sample is a defined template solution. Dilutions of the same stock
 ...
 * biological replicates are not the same).
 */
...
public class SampleType {
	...
	protected Double templateRNAQuantity;
	protected TemplateQualityType templateRNAQuality;
	protected Double templateDNAQuantity;
	...
	public List<IdReferencesType> getDocumentation() {
		...
		if(documentation == null) {
			documentation = new ArrayList<IdReferencesType>();
		}
	...
	public Double getTemplateRNAQuantity() {

		return templateRNAQuantity;
	}

	public void setTemplateRNAQuantity(Double value) {
	...
	public Double getTemplateDNAQuantity() {

		return templateDNAQuantity;
	}

	public void setTemplateDNAQuantity(Double value) {
