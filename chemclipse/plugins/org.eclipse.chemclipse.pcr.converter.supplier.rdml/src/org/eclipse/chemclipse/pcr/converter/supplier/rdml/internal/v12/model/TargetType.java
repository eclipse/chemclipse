...
@XmlType(name = "targetType", propOrder = {"description", "documentation", "xRef", "type", "amplificationEfficiencyMethod", "amplificationEfficiency", "amplificationEfficiencySE", "detectionLimit", "dyeId", "sequences", "commercialAssay"})
