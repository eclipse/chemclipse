 ...
 * @author eselmeister
 */
public class SubtractMultipleChromatogramOffsetUI extends AbstractViewChromatogramUI {
	...
	public void setViewSeries() {
		...
		ISeries series;
		//
		IMultipleSeries multipleSeries = SeriesConverter.convertChromatogramsSubtracted(getChromatogramSelections(), offset, true);
