...
public class ChromatogramEvaluationSelectionHandler implements EventHandler {

	private static final Logger logger = Logger.getLogger(ChromatogramEvaluationSelectionHandler.class);
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Single Chromatogram Evaluation");
			/*
			...
			if(runnable != null) {
				...
				StatusLineLogger.setInfo(InfoType.MESSAGE, "Single Chromatogram Evaluation finished");
			}
		}
	}
