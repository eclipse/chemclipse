...
public class AbstractChromatogramPeakISD extends AbstractPeakISD implements IChromatogramPeakISD {

	private IChromatogramISD chromatogram;
	private static final float INITIAL_SN_VALUE = -1.0f;
	private float signalToNoiseRatio = INITIAL_SN_VALUE;

	public AbstractChromatogramPeakISD(IPeakModelISD peakModel, IChromatogramISD chromatogram) throws IllegalArgumentException, PeakException {
	...
	public AbstractChromatogramPeakISD(IPeakModelISD peakModel, IChromatogramISD chromatogram, String modelDescription) throws IllegalArgumentException, PeakException {
	...
	@Override
	public IChromatogramISD getChromatogram() {
