...
public abstract class AbstractChromatogramSignalFilter extends AbstractChromatogramFilter implements IChromatogramFilter {
	...
	public IProcessingInfo applyFilter(IChromatogramSelection chromatogramSelection, IProgressMonitor monitor) {
		...
		/*
		 * object filterSettings is used only for validation because object can not be null
		 */
		FilterSettings filterSettings = new FilterSettings();
		IProcessingInfo processingInfo = validate(chromatogramSelection, filterSettings);
		if(!processingInfo.hasErrorMessages()) {
