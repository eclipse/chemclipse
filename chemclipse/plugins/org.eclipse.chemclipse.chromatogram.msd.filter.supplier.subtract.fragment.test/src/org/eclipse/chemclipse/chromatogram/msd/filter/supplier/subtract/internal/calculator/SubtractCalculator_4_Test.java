...
public class SubtractCalculator_4_Test extends TestCase {
	...
	public void testMassSpectrumMap_2() {
		...
		assertEquals(20.0f, subtractMassSpectrumMap.get(18.2));
	}

	public void testMassSpectrumMap_3() {

		assertEquals(100.0f, subtractMassSpectrumMap.get(28.1));
	}

	public void testMassSpectrumMap_4() {

		assertEquals(50.0f, subtractMassSpectrumMap.get(32.3));
	}
	...
	public void testSubtractedMassSpectrum_5() {
		...
		try {
			assertEquals(1947.3f, targetMassSpectrum.getIon(32.3).getAbundance());
		} catch(AbundanceLimitExceededException e) {
			assertTrue(false);
		} catch(IonLimitExceededException e) {
			assertTrue(false);
