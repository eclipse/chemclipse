 ...
 *******************************************************************************/
package org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.baselinesubtract.ui.handlers;

import java.lang.reflect.InvocationTargetException;

import javax.inject.Named;

import org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.baselinesubtract.ui.modifier.FilterModifier;
...
public class FilterHandler implements EventHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part) {
		...
		if(chromatogramSelection != null) {
			...
			StatusLineLogger.setInfo(InfoType.MESSAGE, "Start Baseline Subtract Filter");
			/*
			...
			if(runnable != null) {
				...
				StatusLineLogger.setInfo(InfoType.MESSAGE, "Baseline Subtract Filter finished");
			}
		}
	}
