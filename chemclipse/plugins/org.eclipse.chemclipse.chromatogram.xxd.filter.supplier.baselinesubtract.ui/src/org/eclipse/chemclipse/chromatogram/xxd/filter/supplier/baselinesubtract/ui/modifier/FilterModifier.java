 ...
 *******************************************************************************/
package org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.baselinesubtract.ui.modifier;
...
public class FilterModifier extends AbstractChromatogramProcessor implements IRunnableWithProgress {
	...
	private static final String FILTER_ID = "org.eclipse.chemclipse.chromatogram.xxd.filter.supplier.baselinesubtract";
	...
	public void execute(IProgressMonitor monitor) {
		...
		if(getChromatogramSelection() != null) {
			...
			final IProcessingInfo<?> processingInfo = ChromatogramFilter.applyFilter(chromatogramSelection, FILTER_ID, monitor);
