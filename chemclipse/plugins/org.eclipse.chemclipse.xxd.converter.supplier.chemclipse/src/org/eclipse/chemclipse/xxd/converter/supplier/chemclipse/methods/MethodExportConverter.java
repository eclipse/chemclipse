...
public class MethodExportConverter extends AbstractMethodExportConverter implements IMethodExportConverter {

	private static final Logger logger = Logger.getLogger(MethodExportConverter.class);

	@Override
	public IProcessingInfo convert(File file, ProcessMethod processMethod, IProgressMonitor monitor) {
