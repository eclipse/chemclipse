 ...
 */
public class ChromatogramReader_0803 extends AbstractChromatogramReader implements IChromatogramMSDReader {
	...
	private void readBaseline(ZipFile zipFile, IChromatogramMSD chromatogram, IProgressMonitor monitor) throws IOException {
		...
		DataInputStream dataInputStream = getDataInputStream(zipFile, IFormat.FILE_BASELINE);
		/*
		 * Get the Baseline
		 */
