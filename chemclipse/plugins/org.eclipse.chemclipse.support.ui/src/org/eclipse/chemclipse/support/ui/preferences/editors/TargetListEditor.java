...
public class TargetListEditor extends ListEditor {

	public TargetListEditor(String name, String labelText, Composite parent) {
	...
	protected String createList(String[] items) {
		...
		return targetListUtil.createList(items);
	}
	...
	protected String getNewInputObject() {
		...
		List list = getList();
		InputDialog dialog = new InputDialog(Display.getCurrent().getActiveShell(), "Target", "Add a new target.", "", new TargetInputValidator(list));
		dialog.create();
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(list != null) {
					...
					messageBox.setMessage("Would you like to delete the selected target(s) from the list?");
