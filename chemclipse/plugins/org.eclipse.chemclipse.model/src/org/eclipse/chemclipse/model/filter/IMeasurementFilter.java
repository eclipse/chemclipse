...
public interface IMeasurementFilter<ConfigType> extends Filter<ConfigType> {
	...
	/**
	 * Filters the given Collection of {@link IMeasurement}s with this filter, the collection must be modifiable so the filter can either remove an item from the list or filter the item individually
	 * 
	 * @param filterItems
	 * @param configuration
