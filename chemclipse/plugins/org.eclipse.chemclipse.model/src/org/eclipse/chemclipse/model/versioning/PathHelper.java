...
public class PathHelper {
	...
	public static final String CHROMATOGRAM_MODELS = "org.eclipse.chemclipse.model";
	public static final String SERIALIZED_CHROMATOGRAMS = "serializedChromatograms";
	...
	public static File getStoragePath() {
		...
		File file = new File(ApplicationSettings.getSettingsDirectory().getAbsolutePath() + File.separator + CHROMATOGRAM_MODELS + File.separator + SERIALIZED_CHROMATOGRAMS);
		/*
		 * Create the directory if it not exists.
		 */
		if(!file.exists()) {
			if(!file.mkdirs()) {
				logger.warn("The temporarily chromatogram file directory could not be created: " + file.getAbsolutePath());
			}
		}
		return file;
	}
