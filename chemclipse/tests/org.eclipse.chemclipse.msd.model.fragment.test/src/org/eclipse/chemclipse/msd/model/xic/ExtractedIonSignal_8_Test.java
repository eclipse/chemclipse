...
public class ExtractedIonSignal_8_Test extends TestCase {
	...
	public void testSize_1() {
		...
		assertEquals(389.2f, extractedIonSignal.getMedianIntensity());
	}
	...
	public void testSize_2() {
		...
		assertEquals(568.89f, extractedIonSignal.getMedianIntensity());
	}
	...
	public void testSize_3() {
		...
		assertEquals(0.0f, extractedIonSignal.getMedianIntensity());
	}
}
