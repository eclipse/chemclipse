...
public class ChromatogramImportConverter_4_ITest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		super.setUp();
		importFile = new File(TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_4));
