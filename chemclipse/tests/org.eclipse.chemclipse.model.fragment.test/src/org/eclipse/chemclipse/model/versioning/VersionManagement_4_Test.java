 ...
 * doOperation(): _r1<br/>
 * doOperation(): _r2<br/>
 * undoOperation(): _r1<br/>
 * redoOperation(): _r2
 * 
 * @author eselmeister
 */
public class VersionManagement_4_Test extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		versionManagement.doOperation();
		versionManagement.undoOperation();
		versionManagement.redoOperation();
	}
	...
	public void testGetNextScanRevision_1() {
		...
		String absolutePath = versionManagement.getStorageDirectory().getAbsolutePath() + File.separator + "scans" + File.separator + "dumpScans";
		String revisionPath = absolutePath + "_r3";
