...
public class MethodProcessSupport_1_Test extends MethodProcessSupportTestCase {
	...
	public void test6() {
		...
		DataCategory[] methodCategories = new DataCategory[]{DataCategory.MSD, DataCategory.WSD, DataCategory.ISD};
		List<DataCategory[]> processCategories = Collections.emptyList();
		DataCategory[] dataCategories = MethodProcessSupport.getDataTypes(getProcessMethod(methodCategories, processCategories));
		//
		assertNotNull(dataCategories);
	...
	public void test7() {
		...
		DataCategory[] methodCategories = new DataCategory[]{DataCategory.WSD, DataCategory.ISD};
		List<DataCategory[]> processCategories = Collections.emptyList();
		DataCategory[] dataCategories = MethodProcessSupport.getDataTypes(getProcessMethod(methodCategories, processCategories));
		//
		assertNotNull(dataCategories);
	...
	public void test8() {
		...
		DataCategory[] methodCategories = new DataCategory[]{DataCategory.ISD};
		List<DataCategory[]> processCategories = Collections.emptyList();
		DataCategory[] dataCategories = MethodProcessSupport.getDataTypes(getProcessMethod(methodCategories, processCategories));
		//
		assertNotNull(dataCategories);
