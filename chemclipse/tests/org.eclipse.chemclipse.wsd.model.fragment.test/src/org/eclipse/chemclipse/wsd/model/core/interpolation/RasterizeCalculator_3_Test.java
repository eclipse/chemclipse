...
public class RasterizeCalculator_3_Test extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		super.setUp();
		dataOriginal.put(199.5d, 500.0f);
		dataOriginal.put(201.5d, 1000.0f);
		dataOriginal.put(203.5d, 1500.0f);
		dataOriginal.put(205.5d, 1000.0f);
		dataOriginal.put(207.5d, 800.0f);
		dataOriginal.put(209.5d, 600.0f);
	}
