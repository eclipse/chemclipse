...
public class RasterizeCalculator_4_Test extends TestCase {
	...
	private TreeMap<Double, Float> dataOriginal = new TreeMap<>();

	@Override
	protected void setUp() throws Exception {

		super.setUp();
		dataOriginal.put(200.4d, 500.0f);
		dataOriginal.put(202.4d, 1000.0f);
		dataOriginal.put(204.4d, 1500.0f);
		dataOriginal.put(206.4d, 1000.0f);
		dataOriginal.put(208.4d, 800.0f);
		dataOriginal.put(210.4d, 600.0f);
	}
	...
	public void test2() {
		...
		assertEquals(1400.0f, dataRasterized.get(204));
		assertEquals(1350.0f, dataRasterized.get(205));
		assertEquals(1100.0f, dataRasterized.get(206));
