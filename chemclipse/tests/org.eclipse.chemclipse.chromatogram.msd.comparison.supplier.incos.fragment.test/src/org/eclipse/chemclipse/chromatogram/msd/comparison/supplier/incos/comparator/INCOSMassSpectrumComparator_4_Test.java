...
public class INCOSMassSpectrumComparator_4_Test extends MassSpectrumSetTestCase {
	...
	public void test2() {
		...
		assertEquals(60.7614f, result.getMatchFactor());
	}

	public void test3() {

		assertEquals(60.801643f, result.getReverseMatchFactor());
	}
}
