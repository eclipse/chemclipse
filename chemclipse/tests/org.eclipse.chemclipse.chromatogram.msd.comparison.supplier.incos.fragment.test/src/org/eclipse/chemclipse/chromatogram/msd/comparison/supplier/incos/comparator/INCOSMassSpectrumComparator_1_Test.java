...
public class INCOSMassSpectrumComparator_1_Test extends MassSpectrumSetTestCase {
	...
	public void test2() {
		...
		assertEquals(81.44418f, result.getMatchFactor());
	}

	public void test3() {

		assertEquals(81.58592f, result.getReverseMatchFactor());
	}
}
