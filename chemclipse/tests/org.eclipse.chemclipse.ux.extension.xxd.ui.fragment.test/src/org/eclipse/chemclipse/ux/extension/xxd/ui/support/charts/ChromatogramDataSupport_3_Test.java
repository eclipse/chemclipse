...
public class ChromatogramDataSupport_3_Test extends TestCase {
	...
	public void test4() {
		...
		assertEquals("Chromatogram [WSD]", ChromatogramDataSupport.getReferenceLabel(chromatogram, ReferencesLabel.DEFAULT, -1, true));
	}

	public void test5() {

		assertEquals("Master Chromatogram [WSD]", ChromatogramDataSupport.getReferenceLabel(chromatogram, ReferencesLabel.DEFAULT, 0, true));
	}

	public void test6() {

		assertEquals("Referenced Chromatogram (1) [WSD]", ChromatogramDataSupport.getReferenceLabel(chromatogram, ReferencesLabel.DEFAULT, 1, true));
	}
	...
	public void test10() {
		...
		assertEquals("This [WSD]", ChromatogramDataSupport.getReferenceLabel(chromatogram, ReferencesLabel.NAME, -1, true));
	}

	public void test11() {

		assertEquals("This [WSD]", ChromatogramDataSupport.getReferenceLabel(chromatogram, ReferencesLabel.NAME, 0, true));
	}
	...
	public void test14() {
		...
		assertEquals("is [WSD]", ChromatogramDataSupport.getReferenceLabel(chromatogram, ReferencesLabel.DATA_NAME, -1, true));
	}
	...
	public void test16() {
		...
		assertEquals("a [WSD]", ChromatogramDataSupport.getReferenceLabel(chromatogram, ReferencesLabel.SAMPLE_GROUP, -1, true));
	}
	...
	public void test18() {
		...
		assertEquals("test. [WSD]", ChromatogramDataSupport.getReferenceLabel(chromatogram, ReferencesLabel.SHORT_INFO, -1, true));
	}
}
